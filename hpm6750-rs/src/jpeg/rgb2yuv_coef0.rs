...
#[doc = "Field `ENABLE` reader - Asserted to enable this RGB2YCbCr CSC stage"]
pub type ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `ENABLE` writer - Asserted to enable this RGB2YCbCr CSC stage"]
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RGB2YUV_COEF0_SPEC, bool, O>;
#[doc = "Field `YCBCR_MODE` reader - Asserted to use YCrCb mode. Must be assigned as 1."]
pub type YCBCR_MODE_R = crate::BitReader<bool>;
#[doc = "Field `YCBCR_MODE` writer - Asserted to use YCrCb mode. Must be assigned as 1."]
...
impl R {
    ...
    #[doc = "Bit 30 - Asserted to enable this RGB2YCbCr CSC stage"]
    #[inline(always)]
    pub fn enable(&self) -> ENABLE_R {
        ENABLE_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Asserted to use YCrCb mode. Must be assigned as 1."]
    #[inline(always)]
