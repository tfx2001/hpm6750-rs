#[doc = "Register `IMGREG_REG42` reader"]
pub struct R(crate::R<IMGREG_REG42_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IMGREG_REG42_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IMGREG_REG42_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IMGREG_REG42_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IMGREG_REG42` writer"]
pub struct W(crate::W<IMGREG_REG42_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IMGREG_REG42_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IMGREG_REG42_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IMGREG_REG42_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HD_W<'a, const O: u8> = crate::BitWriter<'a, u32, IMGREG_REG42_SPEC, bool, O>;
...
pub type HA_W<'a, const O: u8> = crate::BitWriter<'a, u32, IMGREG_REG42_SPEC, bool, O>;
...
pub type QT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IMGREG_REG42_SPEC, u8, u8, 2, O>;
...
pub type NBLOCK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IMGREG_REG42_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "Image Control Register 42\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [imgreg_reg42](index.html) module"]
pub struct IMGREG_REG42_SPEC;
impl crate::RegisterSpec for IMGREG_REG42_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [imgreg_reg42::R](R) reader structure"]
impl crate::Readable for IMGREG_REG42_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [imgreg_reg42::W](W) writer structure"]
impl crate::Writable for IMGREG_REG42_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IMGREG_REG42 to value 0"]
impl crate::Resettable for IMGREG_REG42_SPEC {
