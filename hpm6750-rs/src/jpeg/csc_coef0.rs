...
#[doc = "Field `ENABLE` reader - Enable the CSC unit. 0b - The CSC is bypassed 1b - The CSC is enabled"]
pub type ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `ENABLE` writer - Enable the CSC unit. 0b - The CSC is bypassed 1b - The CSC is enabled"]
...
impl R {
    ...
    #[doc = "Bit 30 - Enable the CSC unit. 0b - The CSC is bypassed 1b - The CSC is enabled"]
    #[inline(always)]
