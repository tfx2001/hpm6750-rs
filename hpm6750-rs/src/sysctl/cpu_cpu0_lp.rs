#[doc = "Register `CPU_CPU0_LP` reader"]
pub struct R(crate::R<CPU_CPU0_LP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPU_CPU0_LP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPU_CPU0_LP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPU_CPU0_LP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPU_CPU0_LP` writer"]
pub struct W(crate::W<CPU_CPU0_LP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPU_CPU0_LP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPU_CPU0_LP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPU_CPU0_LP_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WAKE_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CPU_CPU0_LP_SPEC, u8, u8, 8, O>;
...
pub type HALT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPU_CPU0_LP_SPEC, bool, O>;
...
pub type WAKE_FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPU_CPU0_LP_SPEC, bool, O>;
...
pub type SLEEP_FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPU_CPU0_LP_SPEC, bool, O>;
...
pub type RESET_FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CPU_CPU0_LP_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CPU_CPU0_LP_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpu_cpu0_lp](index.html) module"]
pub struct CPU_CPU0_LP_SPEC;
impl crate::RegisterSpec for CPU_CPU0_LP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpu_cpu0_lp::R](R) reader structure"]
impl crate::Readable for CPU_CPU0_LP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpu_cpu0_lp::W](W) writer structure"]
impl crate::Writable for CPU_CPU0_LP_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CPU_CPU0_LP to value 0x1200"]
impl crate::Resettable for CPU_CPU0_LP_SPEC {
    #[inline(always)]
