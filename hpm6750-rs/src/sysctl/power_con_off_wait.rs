#[doc = "Register `POWER_CON_OFF_WAIT` reader"]
pub struct R(crate::R<POWER_CON_OFF_WAIT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<POWER_CON_OFF_WAIT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<POWER_CON_OFF_WAIT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<POWER_CON_OFF_WAIT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `POWER_CON_OFF_WAIT` writer"]
pub struct W(crate::W<POWER_CON_OFF_WAIT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<POWER_CON_OFF_WAIT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<POWER_CON_OFF_WAIT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<POWER_CON_OFF_WAIT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WAIT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, POWER_CON_OFF_WAIT_SPEC, u32, u32, 20, O>;
impl R {
...
#[doc = "Power Setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [power_con_off_wait](index.html) module"]
pub struct POWER_CON_OFF_WAIT_SPEC;
impl crate::RegisterSpec for POWER_CON_OFF_WAIT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [power_con_off_wait::R](R) reader structure"]
impl crate::Readable for POWER_CON_OFF_WAIT_SPEC {
    type Reader = R;
}
