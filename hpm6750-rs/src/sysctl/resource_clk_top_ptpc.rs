#[doc = "Register `RESOURCE_CLK_TOP_PTPC` reader"]
pub struct R(crate::R<RESOURCE_CLK_TOP_PTPC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RESOURCE_CLK_TOP_PTPC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RESOURCE_CLK_TOP_PTPC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RESOURCE_CLK_TOP_PTPC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RESOURCE_CLK_TOP_PTPC` writer"]
pub struct W(crate::W<RESOURCE_CLK_TOP_PTPC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RESOURCE_CLK_TOP_PTPC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RESOURCE_CLK_TOP_PTPC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RESOURCE_CLK_TOP_PTPC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RESOURCE_CLK_TOP_PTPC_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "Resource control register for clk_top_ptpc\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [resource_clk_top_ptpc](index.html) module"]
pub struct RESOURCE_CLK_TOP_PTPC_SPEC;
impl crate::RegisterSpec for RESOURCE_CLK_TOP_PTPC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [resource_clk_top_ptpc::R](R) reader structure"]
impl crate::Readable for RESOURCE_CLK_TOP_PTPC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [resource_clk_top_ptpc::W](W) writer structure"]
impl crate::Writable for RESOURCE_CLK_TOP_PTPC_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RESOURCE_CLK_TOP_PTPC to value 0"]
impl crate::Resettable for RESOURCE_CLK_TOP_PTPC_SPEC {
    #[inline(always)]
