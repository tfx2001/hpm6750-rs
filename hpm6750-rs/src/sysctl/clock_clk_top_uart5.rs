#[doc = "Register `CLOCK_CLK_TOP_UART5` reader"]
pub struct R(crate::R<CLOCK_CLK_TOP_UART5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLOCK_CLK_TOP_UART5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLOCK_CLK_TOP_UART5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLOCK_CLK_TOP_UART5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLOCK_CLK_TOP_UART5` writer"]
pub struct W(crate::W<CLOCK_CLK_TOP_UART5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLOCK_CLK_TOP_UART5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLOCK_CLK_TOP_UART5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLOCK_CLK_TOP_UART5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MUX_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLOCK_CLK_TOP_UART5_SPEC, u8, u8, 4, O>;
...
pub type DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLOCK_CLK_TOP_UART5_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Clock setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clock_clk_top_uart5](index.html) module"]
pub struct CLOCK_CLK_TOP_UART5_SPEC;
impl crate::RegisterSpec for CLOCK_CLK_TOP_UART5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clock_clk_top_uart5::R](R) reader structure"]
impl crate::Readable for CLOCK_CLK_TOP_UART5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clock_clk_top_uart5::W](W) writer structure"]
impl crate::Writable for CLOCK_CLK_TOP_UART5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CLOCK_CLK_TOP_UART5 to value 0"]
impl crate::Resettable for CLOCK_CLK_TOP_UART5_SPEC {
    #[inline(always)]
