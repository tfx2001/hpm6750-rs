#[doc = "Register `RESET_CON_CONFIG` reader"]
pub struct R(crate::R<RESET_CON_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RESET_CON_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RESET_CON_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RESET_CON_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RESET_CON_CONFIG` writer"]
pub struct W(crate::W<RESET_CON_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RESET_CON_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RESET_CON_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RESET_CON_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type POST_WAIT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RESET_CON_CONFIG_SPEC, u8, u8, 8, O>;
...
#[doc = "Reset Setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reset_con_config](index.html) module"]
pub struct RESET_CON_CONFIG_SPEC;
impl crate::RegisterSpec for RESET_CON_CONFIG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reset_con_config::R](R) reader structure"]
impl crate::Readable for RESET_CON_CONFIG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reset_con_config::W](W) writer structure"]
impl crate::Writable for RESET_CON_CONFIG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets RESET_CON_CONFIG to value 0x64"]
impl crate::Resettable for RESET_CON_CONFIG_SPEC {
