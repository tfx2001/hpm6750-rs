#[doc = "Register `RESET_CON_CONTROL` reader"]
pub struct R(crate::R<RESET_CON_CONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RESET_CON_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RESET_CON_CONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RESET_CON_CONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RESET_CON_CONTROL` writer"]
pub struct W(crate::W<RESET_CON_CONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RESET_CON_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RESET_CON_CONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RESET_CON_CONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_CON_CONTROL_SPEC, bool, O>;
...
pub type FLAG_WAKE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_CON_CONTROL_SPEC, bool, O>;
...
pub type HOLD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_CON_CONTROL_SPEC, bool, O>;
...
pub type RESET_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_CON_CONTROL_SPEC, bool, O>;
impl R {
...
#[doc = "Reset Setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reset_con_control](index.html) module"]
pub struct RESET_CON_CONTROL_SPEC;
impl crate::RegisterSpec for RESET_CON_CONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reset_con_control::R](R) reader structure"]
impl crate::Readable for RESET_CON_CONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reset_con_control::W](W) writer structure"]
impl crate::Writable for RESET_CON_CONTROL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RESET_CON_CONTROL to value 0x8000_0000"]
impl crate::Resettable for RESET_CON_CONTROL_SPEC {
    #[inline(always)]
