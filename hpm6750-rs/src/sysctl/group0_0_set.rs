#[doc = "Register `GROUP0_0_SET` reader"]
pub struct R(crate::R<GROUP0_0_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GROUP0_0_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GROUP0_0_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GROUP0_0_SET_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type LINK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GROUP0_0_SET_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "`read()` method returns [group0_0_set::R](R) reader structure"]
impl crate::Readable for GROUP0_0_SET_SPEC {
    type Reader = R;
}
