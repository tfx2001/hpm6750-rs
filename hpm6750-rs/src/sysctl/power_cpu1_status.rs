#[doc = "Register `POWER_CPU1_STATUS` reader"]
pub struct R(crate::R<POWER_CPU1_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<POWER_CPU1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<POWER_CPU1_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<POWER_CPU1_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `POWER_CPU1_STATUS` writer"]
pub struct W(crate::W<POWER_CPU1_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<POWER_CPU1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<POWER_CPU1_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<POWER_CPU1_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FLAG_WAKE_W<'a, const O: u8> = crate::BitWriter<'a, u32, POWER_CPU1_STATUS_SPEC, bool, O>;
...
pub type FLAG_W<'a, const O: u8> = crate::BitWriter<'a, u32, POWER_CPU1_STATUS_SPEC, bool, O>;
impl R {
...
#[doc = "Power Setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [power_cpu1_status](index.html) module"]
pub struct POWER_CPU1_STATUS_SPEC;
impl crate::RegisterSpec for POWER_CPU1_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [power_cpu1_status::R](R) reader structure"]
impl crate::Readable for POWER_CPU1_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [power_cpu1_status::W](W) writer structure"]
impl crate::Writable for POWER_CPU1_STATUS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets POWER_CPU1_STATUS to value 0x8000_0000"]
impl crate::Resettable for POWER_CPU1_STATUS_SPEC {
