#[doc = "Register `RESET_CPU0_CONTROL` reader"]
pub struct R(crate::R<RESET_CPU0_CONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RESET_CPU0_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RESET_CPU0_CONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RESET_CPU0_CONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RESET_CPU0_CONTROL` writer"]
pub struct W(crate::W<RESET_CPU0_CONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RESET_CPU0_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RESET_CPU0_CONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RESET_CPU0_CONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Reset Setting\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reset_cpu0_control](index.html) module"]
pub struct RESET_CPU0_CONTROL_SPEC;
impl crate::RegisterSpec for RESET_CPU0_CONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reset_cpu0_control::R](R) reader structure"]
impl crate::Readable for RESET_CPU0_CONTROL_SPEC {
    type Reader = R;
}
