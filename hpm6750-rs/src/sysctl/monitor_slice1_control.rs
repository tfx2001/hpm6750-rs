#[doc = "Register `MONITOR_SLICE1_CONTROL` reader"]
pub struct R(crate::R<MONITOR_SLICE1_CONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MONITOR_SLICE1_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MONITOR_SLICE1_CONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MONITOR_SLICE1_CONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MONITOR_SLICE1_CONTROL` writer"]
pub struct W(crate::W<MONITOR_SLICE1_CONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MONITOR_SLICE1_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MONITOR_SLICE1_CONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MONITOR_SLICE1_CONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SELECTION_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, u8, u8, 8, O>;
...
pub type REFERENCE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
#[doc = "Field `START` reader - start measurement"]
pub type START_R = crate::BitReader<bool>;
#[doc = "Field `START` writer - start measurement"]
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
...
pub type LOW_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
...
pub type HIGH_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
...
pub type OUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
...
pub type VALID_W<'a, const O: u8> = crate::BitWriter<'a, u32, MONITOR_SLICE1_CONTROL_SPEC, bool, O>;
impl R {
...
#[doc = "Clock measure and monitor control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [monitor_slice1_control](index.html) module"]
pub struct MONITOR_SLICE1_CONTROL_SPEC;
impl crate::RegisterSpec for MONITOR_SLICE1_CONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [monitor_slice1_control::R](R) reader structure"]
impl crate::Readable for MONITOR_SLICE1_CONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [monitor_slice1_control::W](W) writer structure"]
impl crate::Writable for MONITOR_SLICE1_CONTROL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MONITOR_SLICE1_CONTROL to value 0"]
impl crate::Resettable for MONITOR_SLICE1_CONTROL_SPEC {
