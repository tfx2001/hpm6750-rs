...
pub struct RegisterBlock {
    ...
    pub secure_state: crate::Reg<secure_state::SECURE_STATE_SPEC>,
    #[doc = "0x04 - secure state configuration"]
    pub secure_state_config: crate::Reg<secure_state_config::SECURE_STATE_CONFIG_SPEC>,
    #[doc = "0x08 - Security violation config"]
    pub violation_config: crate::Reg<violation_config::VIOLATION_CONFIG_SPEC>,
    #[doc = "0x0c - Escalate behavior on security event"]
    pub escalate_config: crate::Reg<escalate_config::ESCALATE_CONFIG_SPEC>,
    #[doc = "0x10 - Event and escalate status"]
    pub event: crate::Reg<event::EVENT_SPEC>,
    #[doc = "0x14 - Lifecycle"]
    pub lifecycle: crate::Reg<lifecycle::LIFECYCLE_SPEC>,
}
#[doc = "SECURE_STATE register accessor: an alias for `Reg<SECURE_STATE_SPEC>`"]
pub type SECURE_STATE = crate::Reg<secure_state::SECURE_STATE_SPEC>;
#[doc = "Secure state"]
pub mod secure_state;
#[doc = "SECURE_STATE_CONFIG register accessor: an alias for `Reg<SECURE_STATE_CONFIG_SPEC>`"]
...
#[doc = "VIOLATION_CONFIG register accessor: an alias for `Reg<VIOLATION_CONFIG_SPEC>`"]
...
#[doc = "ESCALATE_CONFIG register accessor: an alias for `Reg<ESCALATE_CONFIG_SPEC>`"]
...
pub mod event;
#[doc = "LIFECYCLE register accessor: an alias for `Reg<LIFECYCLE_SPEC>`"]
