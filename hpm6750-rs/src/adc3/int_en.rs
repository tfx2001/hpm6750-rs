...
pub type TRIG_CMPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type TRIG_SW_CFLCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type TRIG_HW_CFLCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type READ_CFLCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type SEQ_SW_CFLCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type SEQ_HW_CFLCT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type SEQ_DMAABT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type SEQ_CMPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type SEQ_CVC_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type DMA_FIFO_FULL_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type AHB_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, INT_EN_SPEC, bool, O>;
...
pub type WDOG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, INT_EN_SPEC, u16, u16, 14, O>;
impl R {
    ...
    pub fn wdog(&self) -> WDOG_R {
        WDOG_R::new((self.bits & 0x3fff) as u16)
    }
}
impl W {
    #[doc = "Bit 31 - interrupt for one trigger conversion complete if enabled"]
