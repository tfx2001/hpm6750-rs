#[doc = "Register `CONFIG_TRG2A` reader"]
pub struct R(crate::R<CONFIG_TRG2A_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONFIG_TRG2A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONFIG_TRG2A_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONFIG_TRG2A_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONFIG_TRG2A` writer"]
pub struct W(crate::W<CONFIG_TRG2A_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONFIG_TRG2A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONFIG_TRG2A_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONFIG_TRG2A_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TRIG_LEN` writer - length for current trigger, can up to 4 conversions for one trigger, from 0 to 3"]
pub type TRIG_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG2A_SPEC, u8, u8, 2, O>;
...
pub type INTEN3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG2A_SPEC, bool, O>;
...
pub type CHAN3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG2A_SPEC, u8, u8, 5, O>;
...
pub type INTEN2_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG2A_SPEC, bool, O>;
...
pub type CHAN2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG2A_SPEC, u8, u8, 5, O>;
...
pub type INTEN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG2A_SPEC, bool, O>;
...
pub type CHAN1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG2A_SPEC, u8, u8, 5, O>;
...
pub type INTEN0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG2A_SPEC, bool, O>;
...
pub type CHAN0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG2A_SPEC, u8, u8, 5, O>;
impl R {
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [config_trg2a](index.html) module"]
pub struct CONFIG_TRG2A_SPEC;
impl crate::RegisterSpec for CONFIG_TRG2A_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [config_trg2a::R](R) reader structure"]
impl crate::Readable for CONFIG_TRG2A_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [config_trg2a::W](W) writer structure"]
impl crate::Writable for CONFIG_TRG2A_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CONFIG_TRG2A to value 0"]
impl crate::Resettable for CONFIG_TRG2A_SPEC {
    #[inline(always)]
