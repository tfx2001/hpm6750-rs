#[doc = "Register `CONFIG_TRG0C` reader"]
pub struct R(crate::R<CONFIG_TRG0C_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CONFIG_TRG0C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CONFIG_TRG0C_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CONFIG_TRG0C_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CONFIG_TRG0C` writer"]
pub struct W(crate::W<CONFIG_TRG0C_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CONFIG_TRG0C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CONFIG_TRG0C_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CONFIG_TRG0C_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHAN0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG0C_SPEC, u8, u8, 5, O>;
...
pub type INTEN0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG0C_SPEC, bool, O>;
...
pub type CHAN1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG0C_SPEC, u8, u8, 5, O>;
...
pub type INTEN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG0C_SPEC, bool, O>;
...
pub type CHAN2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG0C_SPEC, u8, u8, 5, O>;
...
pub type INTEN2_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG0C_SPEC, bool, O>;
...
pub type CHAN3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG0C_SPEC, u8, u8, 5, O>;
...
pub type INTEN3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CONFIG_TRG0C_SPEC, bool, O>;
#[doc = "Field `TRIG_LEN` writer - length for current trigger, can up to 4 conversions for one trigger, from 0 to 3"]
pub type TRIG_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CONFIG_TRG0C_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [config_trg0c](index.html) module"]
pub struct CONFIG_TRG0C_SPEC;
impl crate::RegisterSpec for CONFIG_TRG0C_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [config_trg0c::R](R) reader structure"]
impl crate::Readable for CONFIG_TRG0C_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [config_trg0c::W](W) writer structure"]
impl crate::Writable for CONFIG_TRG0C_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CONFIG_TRG0C to value 0"]
impl crate::Resettable for CONFIG_TRG0C_SPEC {
