...
pub struct R(crate::R<GPTIMER1LD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPTIMER1LD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPTIMER1LD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPTIMER1LD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPTIMER1LD` writer"]
pub struct W(crate::W<GPTIMER1LD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPTIMER1LD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPTIMER1LD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPTIMER1LD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GPTLD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPTIMER1LD_SPEC, u32, u32, 24, O>;
impl R {
