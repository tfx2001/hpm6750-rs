#[doc = "Register `ENDPTCTRL_ENDPTCTRL5` reader"]
pub struct R(crate::R<ENDPTCTRL_ENDPTCTRL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ENDPTCTRL_ENDPTCTRL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ENDPTCTRL_ENDPTCTRL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ENDPTCTRL_ENDPTCTRL5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ENDPTCTRL_ENDPTCTRL5` writer"]
pub struct W(crate::W<ENDPTCTRL_ENDPTCTRL5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ENDPTCTRL_ENDPTCTRL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ENDPTCTRL_ENDPTCTRL5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ENDPTCTRL_ENDPTCTRL5_SPEC>) -> Self {
        W(writer)
    }
}
...
1 End Point Stalled This bit is set automatically upon receipt of a SETUP request if this Endpoint is configured as a Control Endpointand this bit will continue to be cleared by hardware until the associated ENDPTSETUPSTAT bit is cleared. Software can write a one to this bit to force the endpoint to return a STALL handshake to the Host. This control will continue to STALL until this bit is either cleared by software or automatically cleared as above for control endpoints. NOTE: \\[CONTROL ENDPOINT TYPES ONLY\\]: there is a slight delay (50 clocks max) between the ENDPTSETUPSTAT begin cleared and hardware continuing to clear this bit. In most systems, it is unlikely the DCD software will observe this delay. However, should the DCD observe that the stall bit is not set after writing a one to it then follow this procedure: continually write this stall bit until it is set or until a new setup has been received by checking the associated endptsetupstat Bit."]
pub type RXS_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
...
pub type RXT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, u8, u8, 2, O>;
...
pub type RXR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
...
1 Enabled An Endpoint should be enabled only after it has been configured."]
pub type RXE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
...
pub type TXS_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
...
pub type TXR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
...
1 Enabled An Endpoint should be enabled only after it has been configured."]
pub type TXE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ENDPTCTRL_ENDPTCTRL5_SPEC, bool, O>;
impl R {
...
#[doc = "Endpoint Control0 Register... Endpoint Control7 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [endptctrl_endptctrl5](index.html) module"]
pub struct ENDPTCTRL_ENDPTCTRL5_SPEC;
impl crate::RegisterSpec for ENDPTCTRL_ENDPTCTRL5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [endptctrl_endptctrl5::R](R) reader structure"]
impl crate::Readable for ENDPTCTRL_ENDPTCTRL5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [endptctrl_endptctrl5::W](W) writer structure"]
impl crate::Writable for ENDPTCTRL_ENDPTCTRL5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ENDPTCTRL_ENDPTCTRL5 to value 0"]
impl crate::Resettable for ENDPTCTRL_ENDPTCTRL5_SPEC {
