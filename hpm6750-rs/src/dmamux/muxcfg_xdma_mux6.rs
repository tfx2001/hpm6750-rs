#[doc = "Register `MUXCFG_XDMA_MUX6` reader"]
pub struct R(crate::R<MUXCFG_XDMA_MUX6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MUXCFG_XDMA_MUX6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MUXCFG_XDMA_MUX6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MUXCFG_XDMA_MUX6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MUXCFG_XDMA_MUX6` writer"]
pub struct W(crate::W<MUXCFG_XDMA_MUX6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MUXCFG_XDMA_MUX6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MUXCFG_XDMA_MUX6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MUXCFG_XDMA_MUX6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SOURCE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MUXCFG_XDMA_MUX6_SPEC, u8, u8, 7, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MUXCFG_XDMA_MUX6_SPEC, bool, O>;
impl R {
...
#[doc = "XDMA MUX6 Configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [muxcfg_xdma_mux6](index.html) module"]
pub struct MUXCFG_XDMA_MUX6_SPEC;
impl crate::RegisterSpec for MUXCFG_XDMA_MUX6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [muxcfg_xdma_mux6::R](R) reader structure"]
impl crate::Readable for MUXCFG_XDMA_MUX6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [muxcfg_xdma_mux6::W](W) writer structure"]
impl crate::Writable for MUXCFG_XDMA_MUX6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MUXCFG_XDMA_MUX6 to value 0"]
impl crate::Resettable for MUXCFG_XDMA_MUX6_SPEC {
