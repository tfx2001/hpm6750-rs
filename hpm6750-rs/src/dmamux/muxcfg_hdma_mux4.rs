#[doc = "Register `MUXCFG_HDMA_MUX4` reader"]
pub struct R(crate::R<MUXCFG_HDMA_MUX4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MUXCFG_HDMA_MUX4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MUXCFG_HDMA_MUX4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MUXCFG_HDMA_MUX4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MUXCFG_HDMA_MUX4` writer"]
pub struct W(crate::W<MUXCFG_HDMA_MUX4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MUXCFG_HDMA_MUX4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MUXCFG_HDMA_MUX4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MUXCFG_HDMA_MUX4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MUXCFG_HDMA_MUX4_SPEC, bool, O>;
...
pub type SOURCE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MUXCFG_HDMA_MUX4_SPEC, u8, u8, 7, O>;
impl R {
...
#[doc = "HDMA MUX4 Configuration\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [muxcfg_hdma_mux4](index.html) module"]
pub struct MUXCFG_HDMA_MUX4_SPEC;
impl crate::RegisterSpec for MUXCFG_HDMA_MUX4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [muxcfg_hdma_mux4::R](R) reader structure"]
impl crate::Readable for MUXCFG_HDMA_MUX4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [muxcfg_hdma_mux4::W](W) writer structure"]
impl crate::Writable for MUXCFG_HDMA_MUX4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MUXCFG_HDMA_MUX4 to value 0"]
impl crate::Resettable for MUXCFG_HDMA_MUX4_SPEC {
    #[inline(always)]
