#[doc = "Register `COUNT_READ_U` reader"]
pub struct R(crate::R<COUNT_READ_U_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COUNT_READ_U_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COUNT_READ_U_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COUNT_READ_U_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "U read register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [count_read_u](index.html) module"]
pub struct COUNT_READ_U_SPEC;
impl crate::RegisterSpec for COUNT_READ_U_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [count_read_u::R](R) reader structure"]
impl crate::Readable for COUNT_READ_U_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets COUNT_READ_U to value 0"]
impl crate::Resettable for COUNT_READ_U_SPEC {
    #[inline(always)]
