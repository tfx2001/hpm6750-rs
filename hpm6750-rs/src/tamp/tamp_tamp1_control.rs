#[doc = "Register `TAMP_TAMP1_CONTROL` reader"]
pub struct R(crate::R<TAMP_TAMP1_CONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TAMP_TAMP1_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TAMP_TAMP1_CONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TAMP_TAMP1_CONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TAMP_TAMP1_CONTROL` writer"]
pub struct W(crate::W<TAMP_TAMP1_CONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TAMP_TAMP1_CONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TAMP_TAMP1_CONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TAMP_TAMP1_CONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, bool, O>;
...
pub type ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, bool, O>;
...
pub type RECOVER_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, bool, O>;
...
pub type SPEED_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, u8, u8, 4, O>;
...
pub type VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, u8, u8, 2, O>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, bool, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, TAMP_TAMP1_CONTROL_SPEC, bool, O>;
impl R {
...
#[doc = "Tamper1 control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tamp_tamp1_control](index.html) module"]
pub struct TAMP_TAMP1_CONTROL_SPEC;
impl crate::RegisterSpec for TAMP_TAMP1_CONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tamp_tamp1_control::R](R) reader structure"]
impl crate::Readable for TAMP_TAMP1_CONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tamp_tamp1_control::W](W) writer structure"]
impl crate::Writable for TAMP_TAMP1_CONTROL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TAMP_TAMP1_CONTROL to value 0"]
impl crate::Resettable for TAMP_TAMP1_CONTROL_SPEC {
