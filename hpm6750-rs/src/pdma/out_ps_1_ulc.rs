#[doc = "Register `OUT_PS_1_ULC` reader"]
pub struct R(crate::R<OUT_PS_1_ULC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OUT_PS_1_ULC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OUT_PS_1_ULC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OUT_PS_1_ULC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OUT_PS_1_ULC` writer"]
pub struct W(crate::W<OUT_PS_1_ULC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OUT_PS_1_ULC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OUT_PS_1_ULC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OUT_PS_1_ULC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type X_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OUT_PS_1_ULC_SPEC, u16, u16, 14, O>;
...
pub type Y_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OUT_PS_1_ULC_SPEC, u16, u16, 14, O>;
impl R {
...
#[doc = "Layer Upper Left Corner Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [out_ps_1_ulc](index.html) module"]
pub struct OUT_PS_1_ULC_SPEC;
impl crate::RegisterSpec for OUT_PS_1_ULC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [out_ps_1_ulc::R](R) reader structure"]
impl crate::Readable for OUT_PS_1_ULC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [out_ps_1_ulc::W](W) writer structure"]
impl crate::Writable for OUT_PS_1_ULC_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OUT_PS_1_ULC to value 0"]
impl crate::Resettable for OUT_PS_1_ULC_SPEC {
