#[doc = "Register `PS_0_OFFSET` reader"]
pub struct R(crate::R<PS_0_OFFSET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PS_0_OFFSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PS_0_OFFSET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PS_0_OFFSET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PS_0_OFFSET` writer"]
pub struct W(crate::W<PS_0_OFFSET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PS_0_OFFSET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PS_0_OFFSET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PS_0_OFFSET_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Layer offset register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ps_0_offset](index.html) module"]
pub struct PS_0_OFFSET_SPEC;
impl crate::RegisterSpec for PS_0_OFFSET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ps_0_offset::R](R) reader structure"]
impl crate::Readable for PS_0_OFFSET_SPEC {
    type Reader = R;
}
