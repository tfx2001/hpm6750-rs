#[doc = "Register `PS_0_CTRL` reader"]
pub struct R(crate::R<PS_0_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PS_0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PS_0_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PS_0_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PS_0_CTRL` writer"]
pub struct W(crate::W<PS_0_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PS_0_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PS_0_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PS_0_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
and bit \\[15:8\\]
before pack_dir operation."]
pub type INB13_SWAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type PACK_DIR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PS_0_CTRL_SPEC, u8, u8, 2, O>;
...
pub type BKGCL4CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type YCBCR_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type VFLIP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type HFLIP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type ROTATE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PS_0_CTRL_SPEC, u8, u8, 2, O>;
...
pub type DECY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PS_0_CTRL_SPEC, u8, u8, 2, O>;
...
pub type DECX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PS_0_CTRL_SPEC, u8, u8, 2, O>;
...
pub type HW_BYTE_SWAP_W<'a, const O: u8> = crate::BitWriter<'a, u32, PS_0_CTRL_SPEC, bool, O>;
...
pub type FORMAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PS_0_CTRL_SPEC, u8, u8, 6, O>;
impl R {
...
#[doc = "Layer Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ps_0_ctrl](index.html) module"]
pub struct PS_0_CTRL_SPEC;
impl crate::RegisterSpec for PS_0_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ps_0_ctrl::R](R) reader structure"]
impl crate::Readable for PS_0_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ps_0_ctrl::W](W) writer structure"]
impl crate::Writable for PS_0_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PS_0_CTRL to value 0"]
impl crate::Resettable for PS_0_CTRL_SPEC {
    #[inline(always)]
