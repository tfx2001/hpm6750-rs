#[doc = "Register `PRD_CFG_CHN16_PRD_RESULT` reader"]
pub struct R(crate::R<PRD_CFG_CHN16_PRD_RESULT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRD_CFG_CHN16_PRD_RESULT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRD_CFG_CHN16_PRD_RESULT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRD_CFG_CHN16_PRD_RESULT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [prd_cfg_chn16_prd_result](index.html) module"]
pub struct PRD_CFG_CHN16_PRD_RESULT_SPEC;
impl crate::RegisterSpec for PRD_CFG_CHN16_PRD_RESULT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [prd_cfg_chn16_prd_result::R](R) reader structure"]
impl crate::Readable for PRD_CFG_CHN16_PRD_RESULT_SPEC {
    type Reader = R;
}
