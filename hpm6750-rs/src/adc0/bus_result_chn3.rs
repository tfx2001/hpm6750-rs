#[doc = "Register `BUS_RESULT_CHN3` reader"]
pub struct R(crate::R<BUS_RESULT_CHN3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUS_RESULT_CHN3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUS_RESULT_CHN3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUS_RESULT_CHN3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [bus_result_chn3](index.html) module"]
pub struct BUS_RESULT_CHN3_SPEC;
impl crate::RegisterSpec for BUS_RESULT_CHN3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [bus_result_chn3::R](R) reader structure"]
impl crate::Readable for BUS_RESULT_CHN3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets BUS_RESULT_CHN3 to value 0"]
impl crate::Resettable for BUS_RESULT_CHN3_SPEC {
    #[inline(always)]
