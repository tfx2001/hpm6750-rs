#[doc = "Register `TRGOCFG_PWM_IN23` reader"]
pub struct R(crate::R<TRGOCFG_PWM_IN23_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRGOCFG_PWM_IN23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRGOCFG_PWM_IN23_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRGOCFG_PWM_IN23_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRGOCFG_PWM_IN23` writer"]
pub struct W(crate::W<TRGOCFG_PWM_IN23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRGOCFG_PWM_IN23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRGOCFG_PWM_IN23_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRGOCFG_PWM_IN23_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TRIGOSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TRGOCFG_PWM_IN23_SPEC, u8, u8, 6, O>;
...
pub type REDG2PEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRGOCFG_PWM_IN23_SPEC, bool, O>;
...
pub type FEDG2PEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRGOCFG_PWM_IN23_SPEC, bool, O>;
...
pub type OUTINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRGOCFG_PWM_IN23_SPEC, bool, O>;
impl R {
...
#[doc = "Trigger manager output configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [trgocfg_pwm_in23](index.html) module"]
pub struct TRGOCFG_PWM_IN23_SPEC;
impl crate::RegisterSpec for TRGOCFG_PWM_IN23_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [trgocfg_pwm_in23::R](R) reader structure"]
impl crate::Readable for TRGOCFG_PWM_IN23_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [trgocfg_pwm_in23::W](W) writer structure"]
impl crate::Writable for TRGOCFG_PWM_IN23_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TRGOCFG_PWM_IN23 to value 0"]
impl crate::Resettable for TRGOCFG_PWM_IN23_SPEC {
