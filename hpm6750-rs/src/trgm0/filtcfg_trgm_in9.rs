#[doc = "Register `FILTCFG_TRGM_IN9` reader"]
pub struct R(crate::R<FILTCFG_TRGM_IN9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FILTCFG_TRGM_IN9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FILTCFG_TRGM_IN9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FILTCFG_TRGM_IN9_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FILTCFG_TRGM_IN9` writer"]
pub struct W(crate::W<FILTCFG_TRGM_IN9_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FILTCFG_TRGM_IN9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FILTCFG_TRGM_IN9_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FILTCFG_TRGM_IN9_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FILTLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FILTCFG_TRGM_IN9_SPEC, u16, u16, 12, O>;
...
pub type SYNCEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, FILTCFG_TRGM_IN9_SPEC, bool, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FILTCFG_TRGM_IN9_SPEC, u8, u8, 3, O>;
...
pub type OUTINV_W<'a, const O: u8> = crate::BitWriter<'a, u32, FILTCFG_TRGM_IN9_SPEC, bool, O>;
impl R {
...
#[doc = "Filter configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [filtcfg_trgm_in9](index.html) module"]
pub struct FILTCFG_TRGM_IN9_SPEC;
impl crate::RegisterSpec for FILTCFG_TRGM_IN9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [filtcfg_trgm_in9::R](R) reader structure"]
impl crate::Readable for FILTCFG_TRGM_IN9_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [filtcfg_trgm_in9::W](W) writer structure"]
impl crate::Writable for FILTCFG_TRGM_IN9_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FILTCFG_TRGM_IN9 to value 0"]
impl crate::Resettable for FILTCFG_TRGM_IN9_SPEC {
