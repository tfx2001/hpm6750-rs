#[doc = "Register `LAYER_2_LINECFG` reader"]
pub struct R(crate::R<LAYER_2_LINECFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LAYER_2_LINECFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LAYER_2_LINECFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LAYER_2_LINECFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LAYER_2_LINECFG` writer"]
pub struct W(crate::W<LAYER_2_LINECFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LAYER_2_LINECFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LAYER_2_LINECFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LAYER_2_LINECFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PITCH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYER_2_LINECFG_SPEC, u16, u16, 16, O>;
...
pub type MAX_OT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LAYER_2_LINECFG_SPEC, u8, u8, 3, O>;
...
#[doc = "Layer Bus Config Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [layer_2_linecfg](index.html) module"]
pub struct LAYER_2_LINECFG_SPEC;
impl crate::RegisterSpec for LAYER_2_LINECFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [layer_2_linecfg::R](R) reader structure"]
impl crate::Readable for LAYER_2_LINECFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [layer_2_linecfg::W](W) writer structure"]
impl crate::Writable for LAYER_2_LINECFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LAYER_2_LINECFG to value 0"]
impl crate::Resettable for LAYER_2_LINECFG_SPEC {
