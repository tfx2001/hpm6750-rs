#[doc = "Register `LAYER_1_LAYPOS` reader"]
pub struct R(crate::R<LAYER_1_LAYPOS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LAYER_1_LAYPOS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LAYER_1_LAYPOS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LAYER_1_LAYPOS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LAYER_1_LAYPOS` writer"]
pub struct W(crate::W<LAYER_1_LAYPOS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LAYER_1_LAYPOS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LAYER_1_LAYPOS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LAYER_1_LAYPOS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type Y_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LAYER_1_LAYPOS_SPEC, u16, u16, 16, O>;
...
pub type X_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LAYER_1_LAYPOS_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "Layer Position Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [layer_1_laypos](index.html) module"]
pub struct LAYER_1_LAYPOS_SPEC;
impl crate::RegisterSpec for LAYER_1_LAYPOS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [layer_1_laypos::R](R) reader structure"]
impl crate::Readable for LAYER_1_LAYPOS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [layer_1_laypos::W](W) writer structure"]
impl crate::Writable for LAYER_1_LAYPOS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets LAYER_1_LAYPOS to value 0"]
impl crate::Resettable for LAYER_1_LAYPOS_SPEC {
    #[inline(always)]
