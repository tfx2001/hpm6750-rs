#[doc = "Register `MAC_ADDR_1_HIGH` reader"]
pub struct R(crate::R<MAC_ADDR_1_HIGH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MAC_ADDR_1_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MAC_ADDR_1_HIGH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MAC_ADDR_1_HIGH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAC_ADDR_1_HIGH` writer"]
pub struct W(crate::W<MAC_ADDR_1_HIGH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MAC_ADDR_1_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MAC_ADDR_1_HIGH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MAC_ADDR_1_HIGH_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDRHI_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MAC_ADDR_1_HIGH_SPEC, u16, u16, 16, O>;
...
- ... - Bit 24: Register 19\\[7:0\\]
You can filter a group of addresses (known as group address filtering) by masking one or more bytes of the address."]
pub type MBC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAC_ADDR_1_HIGH_SPEC, u8, u8, 6, O>;
...
is used to compare with the SA fields of the received frame. When this bit is reset, the MAC Address1\\[47:0\\]
is used to compare with the DA fields of the received frame."]
pub type SA_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_ADDR_1_HIGH_SPEC, bool, O>;
...
pub type AE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_ADDR_1_HIGH_SPEC, bool, O>;
impl R {
...
#[doc = "MAC Address High Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mac_addr_1_high](index.html) module"]
pub struct MAC_ADDR_1_HIGH_SPEC;
impl crate::RegisterSpec for MAC_ADDR_1_HIGH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mac_addr_1_high::R](R) reader structure"]
impl crate::Readable for MAC_ADDR_1_HIGH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mac_addr_1_high::W](W) writer structure"]
impl crate::Writable for MAC_ADDR_1_HIGH_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MAC_ADDR_1_HIGH to value 0"]
impl crate::Resettable for MAC_ADDR_1_HIGH_SPEC {
