...
#[doc = "Register `TXMULTICOL_G` writer"]
pub struct W(crate::W<TXMULTICOL_G_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXMULTICOL_G_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXMULTICOL_G_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXMULTICOL_G_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `FRMCNT` reader - Number of successfully transmitted frames after multiple collisions in the half-duplex mode."]
pub type FRMCNT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `FRMCNT` writer - Number of successfully transmitted frames after multiple collisions in the half-duplex mode."]
pub type FRMCNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TXMULTICOL_G_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Number of successfully transmitted frames after multiple collisions in the half-duplex mode."]
    #[inline(always)]
...
#[doc = "`write(|w| ..)` method takes [txmulticol_g::W](W) writer structure"]
impl crate::Writable for TXMULTICOL_G_SPEC {
    type Writer = W;
}
