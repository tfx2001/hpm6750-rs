...
pub struct R(crate::R<RXIPV4_NOPAY_OCTETS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXIPV4_NOPAY_OCTETS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXIPV4_NOPAY_OCTETS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXIPV4_NOPAY_OCTETS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXIPV4_NOPAY_OCTETS` writer"]
pub struct W(crate::W<RXIPV4_NOPAY_OCTETS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXIPV4_NOPAY_OCTETS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXIPV4_NOPAY_OCTETS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXIPV4_NOPAY_OCTETS_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `BYTECNT` reader - Number of bytes received in IPv4 datagrams that did not have a TCP, UDP, or ICMP payload. The value in the IPv4 header’s Length field is used to update this counter."]
pub type BYTECNT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BYTECNT` writer - Number of bytes received in IPv4 datagrams that did not have a TCP, UDP, or ICMP payload. The value in the IPv4 header’s Length field is used to update this counter."]
pub type BYTECNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RXIPV4_NOPAY_OCTETS_SPEC, u32, u32, 32, O>;
impl R {
