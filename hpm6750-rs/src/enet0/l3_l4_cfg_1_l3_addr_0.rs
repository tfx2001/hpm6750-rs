#[doc = "Register `L3_L4_CFG_1_L3_ADDR_0` reader"]
pub struct R(crate::R<L3_L4_CFG_1_L3_ADDR_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L3_L4_CFG_1_L3_ADDR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L3_L4_CFG_1_L3_ADDR_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L3_L4_CFG_1_L3_ADDR_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L3_L4_CFG_1_L3_ADDR_0` writer"]
pub struct W(crate::W<L3_L4_CFG_1_L3_ADDR_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L3_L4_CFG_1_L3_ADDR_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L3_L4_CFG_1_L3_ADDR_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L3_L4_CFG_1_L3_ADDR_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type L3A00_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, L3_L4_CFG_1_L3_ADDR_0_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "Layer 3 Address 0 Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l3_l4_cfg_1_l3_addr_0](index.html) module"]
pub struct L3_L4_CFG_1_L3_ADDR_0_SPEC;
impl crate::RegisterSpec for L3_L4_CFG_1_L3_ADDR_0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [l3_l4_cfg_1_l3_addr_0::R](R) reader structure"]
impl crate::Readable for L3_L4_CFG_1_L3_ADDR_0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [l3_l4_cfg_1_l3_addr_0::W](W) writer structure"]
impl crate::Writable for L3_L4_CFG_1_L3_ADDR_0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets L3_L4_CFG_1_L3_ADDR_0 to value 0"]
impl crate::Resettable for L3_L4_CFG_1_L3_ADDR_0_SPEC {
    #[inline(always)]
