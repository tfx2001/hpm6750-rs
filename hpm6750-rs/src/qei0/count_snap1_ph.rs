#[doc = "Register `COUNT_SNAP1_PH` reader"]
pub struct R(crate::R<COUNT_SNAP1_PH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COUNT_SNAP1_PH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COUNT_SNAP1_PH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COUNT_SNAP1_PH_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Phase snap register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [count_snap1_ph](index.html) module"]
pub struct COUNT_SNAP1_PH_SPEC;
impl crate::RegisterSpec for COUNT_SNAP1_PH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [count_snap1_ph::R](R) reader structure"]
impl crate::Readable for COUNT_SNAP1_PH_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets COUNT_SNAP1_PH to value 0"]
impl crate::Resettable for COUNT_SNAP1_PH_SPEC {
    #[inline(always)]
