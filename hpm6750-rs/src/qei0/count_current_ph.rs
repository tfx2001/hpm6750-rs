#[doc = "Register `COUNT_CURRENT_PH` reader"]
pub struct R(crate::R<COUNT_CURRENT_PH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COUNT_CURRENT_PH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COUNT_CURRENT_PH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COUNT_CURRENT_PH_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Phase counter\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [count_current_ph](index.html) module"]
pub struct COUNT_CURRENT_PH_SPEC;
impl crate::RegisterSpec for COUNT_CURRENT_PH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [count_current_ph::R](R) reader structure"]
impl crate::Readable for COUNT_CURRENT_PH_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets COUNT_CURRENT_PH to value 0"]
impl crate::Resettable for COUNT_CURRENT_PH_SPEC {
    #[inline(always)]
