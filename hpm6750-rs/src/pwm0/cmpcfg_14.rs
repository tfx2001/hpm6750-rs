#[doc = "Register `CMPCFG_14` reader"]
pub struct R(crate::R<CMPCFG_14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMPCFG_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMPCFG_14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMPCFG_14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMPCFG_14` writer"]
pub struct W(crate::W<CMPCFG_14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMPCFG_14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMPCFG_14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPCFG_14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XCNTCMPEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPCFG_14_SPEC, u8, u8, 4, O>;
...
pub type CMPSHDWUPT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPCFG_14_SPEC, u8, u8, 2, O>;
...
pub type CMPMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMPCFG_14_SPEC, bool, O>;
impl R {
...
#[doc = "Comparator configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpcfg_14](index.html) module"]
pub struct CMPCFG_14_SPEC;
impl crate::RegisterSpec for CMPCFG_14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmpcfg_14::R](R) reader structure"]
impl crate::Readable for CMPCFG_14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmpcfg_14::W](W) writer structure"]
impl crate::Writable for CMPCFG_14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CMPCFG_14 to value 0"]
impl crate::Resettable for CMPCFG_14_SPEC {
    #[inline(always)]
