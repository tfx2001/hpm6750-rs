#[doc = "Register `CMP_20` reader"]
pub struct R(crate::R<CMP_20_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP_20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP_20_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP_20_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP_20` writer"]
pub struct W(crate::W<CMP_20_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP_20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP_20_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP_20_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XCMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_20_SPEC, u8, u8, 4, O>;
...
pub type CMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_20_SPEC, u32, u32, 24, O>;
...
pub type CMPHLF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMP_20_SPEC, bool, O>;
...
pub type CMPJIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_20_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "Comparator register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmp_20](index.html) module"]
pub struct CMP_20_SPEC;
impl crate::RegisterSpec for CMP_20_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmp_20::R](R) reader structure"]
impl crate::Readable for CMP_20_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmp_20::W](W) writer structure"]
impl crate::Writable for CMP_20_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CMP_20 to value 0"]
impl crate::Resettable for CMP_20_SPEC {
    #[inline(always)]
