#[doc = "Register `CMPCFG_6` reader"]
pub struct R(crate::R<CMPCFG_6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMPCFG_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMPCFG_6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMPCFG_6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMPCFG_6` writer"]
pub struct W(crate::W<CMPCFG_6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMPCFG_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMPCFG_6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPCFG_6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XCNTCMPEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPCFG_6_SPEC, u8, u8, 4, O>;
...
pub type CMPSHDWUPT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPCFG_6_SPEC, u8, u8, 2, O>;
...
pub type CMPMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMPCFG_6_SPEC, bool, O>;
impl R {
...
#[doc = "Comparator configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpcfg_6](index.html) module"]
pub struct CMPCFG_6_SPEC;
impl crate::RegisterSpec for CMPCFG_6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmpcfg_6::R](R) reader structure"]
impl crate::Readable for CMPCFG_6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmpcfg_6::W](W) writer structure"]
impl crate::Writable for CMPCFG_6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CMPCFG_6 to value 0"]
impl crate::Resettable for CMPCFG_6_SPEC {
    #[inline(always)]
