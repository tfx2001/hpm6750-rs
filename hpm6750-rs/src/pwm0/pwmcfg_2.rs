#[doc = "Register `PWMCFG_2` reader"]
pub struct R(crate::R<PWMCFG_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWMCFG_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PWMCFG_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PWMCFG_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PWMCFG_2` writer"]
pub struct W(crate::W<PWMCFG_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PWMCFG_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PWMCFG_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PWMCFG_2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWMCFG_2_SPEC, bool, O>;
...
pub type FRCSHDWUPT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWMCFG_2_SPEC, u8, u8, 2, O>;
...
pub type FAULTMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWMCFG_2_SPEC, u8, u8, 2, O>;
...
pub type FAULTRECTIME_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWMCFG_2_SPEC, u8, u8, 2, O>;
...
pub type FRCSRCSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWMCFG_2_SPEC, bool, O>;
...
pub type PAIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, PWMCFG_2_SPEC, bool, O>;
...
pub type DEADAREA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PWMCFG_2_SPEC, u32, u32, 20, O>;
impl R {
    ...
    pub fn deadarea(&self) -> DEADAREA_R {
        DEADAREA_R::new((self.bits & 0x000f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bit 28 - PWM output enable 1- output is enabled 0- output is disabled"]
...
#[doc = "PWM channel configure register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwmcfg_2](index.html) module"]
pub struct PWMCFG_2_SPEC;
impl crate::RegisterSpec for PWMCFG_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwmcfg_2::R](R) reader structure"]
impl crate::Readable for PWMCFG_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pwmcfg_2::W](W) writer structure"]
impl crate::Writable for PWMCFG_2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PWMCFG_2 to value 0"]
impl crate::Resettable for PWMCFG_2_SPEC {
    #[inline(always)]
