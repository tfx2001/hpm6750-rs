...
pub type CMPJIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_3_SPEC, u8, u8, 3, O>;
...
pub type CMPHLF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMP_3_SPEC, bool, O>;
...
pub type CMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_3_SPEC, u32, u32, 24, O>;
...
pub type XCMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_3_SPEC, u8, u8, 4, O>;
impl R {
