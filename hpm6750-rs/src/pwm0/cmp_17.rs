#[doc = "Register `CMP_17` reader"]
pub struct R(crate::R<CMP_17_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMP_17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMP_17_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMP_17_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMP_17` writer"]
pub struct W(crate::W<CMP_17_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMP_17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMP_17_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMP_17_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CMPJIT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_17_SPEC, u8, u8, 3, O>;
...
pub type CMPHLF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMP_17_SPEC, bool, O>;
...
pub type CMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_17_SPEC, u32, u32, 24, O>;
...
pub type XCMP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMP_17_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "Comparator register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmp_17](index.html) module"]
pub struct CMP_17_SPEC;
impl crate::RegisterSpec for CMP_17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cmp_17::R](R) reader structure"]
impl crate::Readable for CMP_17_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cmp_17::W](W) writer structure"]
impl crate::Writable for CMP_17_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CMP_17 to value 0"]
impl crate::Resettable for CMP_17_SPEC {
