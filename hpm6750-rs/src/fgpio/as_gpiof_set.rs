#[doc = "Register `AS_GPIOF_SET` reader"]
pub struct R(crate::R<AS_GPIOF_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AS_GPIOF_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AS_GPIOF_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AS_GPIOF_SET_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AS_GPIOF_SET` writer"]
pub struct W(crate::W<AS_GPIOF_SET_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AS_GPIOF_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AS_GPIOF_SET_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AS_GPIOF_SET_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IRQ_ASYNC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AS_GPIOF_SET_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "GPIO interrupt asynchronous set\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [as_gpiof_set](index.html) module"]
pub struct AS_GPIOF_SET_SPEC;
impl crate::RegisterSpec for AS_GPIOF_SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [as_gpiof_set::R](R) reader structure"]
impl crate::Readable for AS_GPIOF_SET_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [as_gpiof_set::W](W) writer structure"]
impl crate::Writable for AS_GPIOF_SET_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets AS_GPIOF_SET to value 0"]
impl crate::Resettable for AS_GPIOF_SET_SPEC {
