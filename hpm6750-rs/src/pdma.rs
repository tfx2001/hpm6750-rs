...
#[doc = "PS_0_CLRKEY_HIGH (rw) register accessor: an alias for `Reg<PS_0_CLRKEY_HIGH_SPEC>`"]
...
#[doc = "PS_0_ORG (rw) register accessor: an alias for `Reg<PS_0_ORG_SPEC>`"]
pub type PS_0_ORG = crate::Reg<ps_0_org::PS_0_ORG_SPEC>;
#[doc = "Layer original size register"]
pub mod ps_0_org;
#[doc = "PS_1_CTRL (rw) register accessor: an alias for `Reg<PS_1_CTRL_SPEC>`"]
pub type PS_1_CTRL = crate::Reg<ps_1_ctrl::PS_1_CTRL_SPEC>;
#[doc = "layer control register"]
pub mod ps_1_ctrl;
#[doc = "PS_1_BUF (rw) register accessor: an alias for `Reg<PS_1_BUF_SPEC>`"]
pub type PS_1_BUF = crate::Reg<ps_1_buf::PS_1_BUF_SPEC>;
#[doc = "Layer data buffer address"]
pub mod ps_1_buf;
#[doc = "PS_1_PITCH (rw) register accessor: an alias for `Reg<PS_1_PITCH_SPEC>`"]
pub type PS_1_PITCH = crate::Reg<ps_1_pitch::PS_1_PITCH_SPEC>;
#[doc = "Layer data pitch register"]
pub mod ps_1_pitch;
#[doc = "PS_1_BKGD (rw) register accessor: an alias for `Reg<PS_1_BKGD_SPEC>`"]
pub type PS_1_BKGD = crate::Reg<ps_1_bkgd::PS_1_BKGD_SPEC>;
#[doc = "Layer background color register"]
pub mod ps_1_bkgd;
#[doc = "PS_1_SCALE (rw) register accessor: an alias for `Reg<PS_1_SCALE_SPEC>`"]
pub type PS_1_SCALE = crate::Reg<ps_1_scale::PS_1_SCALE_SPEC>;
#[doc = "Layer scale register"]
pub mod ps_1_scale;
#[doc = "PS_1_OFFSET (rw) register accessor: an alias for `Reg<PS_1_OFFSET_SPEC>`"]
pub type PS_1_OFFSET = crate::Reg<ps_1_offset::PS_1_OFFSET_SPEC>;
#[doc = "Layer offset register"]
pub mod ps_1_offset;
#[doc = "PS_1_CLRKEY_LOW (rw) register accessor: an alias for `Reg<PS_1_CLRKEY_LOW_SPEC>`"]
pub type PS_1_CLRKEY_LOW = crate::Reg<ps_1_clrkey_low::PS_1_CLRKEY_LOW_SPEC>;
#[doc = "Layer low color key register"]
pub mod ps_1_clrkey_low;
#[doc = "PS_1_CLRKEY_HIGH (rw) register accessor: an alias for `Reg<PS_1_CLRKEY_HIGH_SPEC>`"]
pub type PS_1_CLRKEY_HIGH = crate::Reg<ps_1_clrkey_high::PS_1_CLRKEY_HIGH_SPEC>;
#[doc = "Layer high color key register"]
pub mod ps_1_clrkey_high;
#[doc = "PS_1_ORG (rw) register accessor: an alias for `Reg<PS_1_ORG_SPEC>`"]
pub type PS_1_ORG = crate::Reg<ps_1_org::PS_1_ORG_SPEC>;
#[doc = "Layer original size register"]
pub mod ps_1_org;
#[doc = "YUV2RGB_COEF0 (rw) register accessor: an alias for `Reg<YUV2RGB_COEF0_SPEC>`"]
...
#[doc = "YUV2RGB_COEF1 (rw) register accessor: an alias for `Reg<YUV2RGB_COEF1_SPEC>`"]
...
#[doc = "YUV2RGB_COEF2 (rw) register accessor: an alias for `Reg<YUV2RGB_COEF2_SPEC>`"]
...
#[doc = "RGB2YUV_COEF0 (rw) register accessor: an alias for `Reg<RGB2YUV_COEF0_SPEC>`"]
...
#[doc = "RGB2YUV_COEF1 (rw) register accessor: an alias for `Reg<RGB2YUV_COEF1_SPEC>`"]
...
#[doc = "RGB2YUV_COEF2 (rw) register accessor: an alias for `Reg<RGB2YUV_COEF2_SPEC>`"]
...
#[doc = "RGB2YUV_COEF3 (rw) register accessor: an alias for `Reg<RGB2YUV_COEF3_SPEC>`"]
...
#[doc = "RGB2YUV_COEF4 (rw) register accessor: an alias for `Reg<RGB2YUV_COEF4_SPEC>`"]
