...
pub struct W(crate::W<WREN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WREN_SPEC>;
    #[inline(always)]
...
impl From<crate::W<WREN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WREN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, WREN_SPEC, u16, u16, 16, O>;
impl W {
...
#[doc = "Write Protection Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [wren](index.html) module"]
pub struct WREN_SPEC;
impl crate::RegisterSpec for WREN_SPEC {
    type Ux = u32;
}
