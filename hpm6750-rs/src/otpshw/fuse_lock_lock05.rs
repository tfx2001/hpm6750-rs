#[doc = "Register `FUSE_LOCK_LOCK05` reader"]
pub struct R(crate::R<FUSE_LOCK_LOCK05_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FUSE_LOCK_LOCK05_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FUSE_LOCK_LOCK05_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FUSE_LOCK_LOCK05_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FUSE_LOCK_LOCK05` writer"]
pub struct W(crate::W<FUSE_LOCK_LOCK05_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FUSE_LOCK_LOCK05_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FUSE_LOCK_LOCK05_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FUSE_LOCK_LOCK05_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOCK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, FUSE_LOCK_LOCK05_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "Fuse lock\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fuse_lock_lock05](index.html) module"]
pub struct FUSE_LOCK_LOCK05_SPEC;
impl crate::RegisterSpec for FUSE_LOCK_LOCK05_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fuse_lock_lock05::R](R) reader structure"]
impl crate::Readable for FUSE_LOCK_LOCK05_SPEC {
    type Reader = R;
}
