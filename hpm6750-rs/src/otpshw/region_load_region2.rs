#[doc = "Register `REGION_LOAD_REGION2` reader"]
pub struct R(crate::R<REGION_LOAD_REGION2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REGION_LOAD_REGION2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REGION_LOAD_REGION2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REGION_LOAD_REGION2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REGION_LOAD_REGION2` writer"]
pub struct W(crate::W<REGION_LOAD_REGION2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REGION_LOAD_REGION2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REGION_LOAD_REGION2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REGION_LOAD_REGION2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, REGION_LOAD_REGION2_SPEC, u8, u8, 7, O>;
...
#[doc = "LOAD region\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [region_load_region2](index.html) module"]
pub struct REGION_LOAD_REGION2_SPEC;
impl crate::RegisterSpec for REGION_LOAD_REGION2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [region_load_region2::R](R) reader structure"]
impl crate::Readable for REGION_LOAD_REGION2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [region_load_region2::W](W) writer structure"]
impl crate::Writable for REGION_LOAD_REGION2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets REGION_LOAD_REGION2 to value 0x10"]
impl crate::Resettable for REGION_LOAD_REGION2_SPEC {
