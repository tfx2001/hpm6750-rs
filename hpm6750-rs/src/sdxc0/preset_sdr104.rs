#[doc = "Register `PRESET_SDR104` reader"]
pub struct R(crate::R<PRESET_SDR104_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PRESET_SDR104_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PRESET_SDR104_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PRESET_SDR104_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "No description avaiable\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [preset_sdr104](index.html) module"]
pub struct PRESET_SDR104_SPEC;
impl crate::RegisterSpec for PRESET_SDR104_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [preset_sdr104::R](R) reader structure"]
impl crate::Readable for PRESET_SDR104_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PRESET_SDR104 to value 0"]
impl crate::Resettable for PRESET_SDR104_SPEC {
    #[inline(always)]
