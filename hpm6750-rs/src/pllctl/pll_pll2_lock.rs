#[doc = "Register `PLL_PLL2_LOCK` reader"]
pub struct R(crate::R<PLL_PLL2_LOCK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_PLL2_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_PLL2_LOCK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_PLL2_LOCK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_PLL2_LOCK` writer"]
pub struct W(crate::W<PLL_PLL2_LOCK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_PLL2_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_PLL2_LOCK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_PLL2_LOCK_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PLLx lock control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_pll2_lock](index.html) module"]
pub struct PLL_PLL2_LOCK_SPEC;
impl crate::RegisterSpec for PLL_PLL2_LOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_pll2_lock::R](R) reader structure"]
impl crate::Readable for PLL_PLL2_LOCK_SPEC {
    type Reader = R;
}
