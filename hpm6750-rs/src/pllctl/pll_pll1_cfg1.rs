#[doc = "Register `PLL_PLL1_CFG1` reader"]
pub struct R(crate::R<PLL_PLL1_CFG1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_PLL1_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_PLL1_CFG1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_PLL1_CFG1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_PLL1_CFG1` writer"]
pub struct W(crate::W<PLL_PLL1_CFG1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_PLL1_CFG1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_PLL1_CFG1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_PLL1_CFG1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PLLCTRL_HW_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_CFG1_SPEC, bool, O>;
...
pub type CLKEN_SW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_CFG1_SPEC, bool, O>;
...
pub type PLLPD_SW_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_CFG1_SPEC, bool, O>;
...
pub type LOCK_CNT_CFG_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_CFG1_SPEC, bool, O>;
impl R {
...
#[doc = "PLLx config1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_pll1_cfg1](index.html) module"]
pub struct PLL_PLL1_CFG1_SPEC;
impl crate::RegisterSpec for PLL_PLL1_CFG1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_pll1_cfg1::R](R) reader structure"]
impl crate::Readable for PLL_PLL1_CFG1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_pll1_cfg1::W](W) writer structure"]
impl crate::Writable for PLL_PLL1_CFG1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PLL_PLL1_CFG1 to value 0x8000_0000"]
impl crate::Resettable for PLL_PLL1_CFG1_SPEC {
    #[inline(always)]
