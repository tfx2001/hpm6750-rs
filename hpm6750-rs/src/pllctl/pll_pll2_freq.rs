#[doc = "Register `PLL_PLL2_FREQ` reader"]
pub struct R(crate::R<PLL_PLL2_FREQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_PLL2_FREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_PLL2_FREQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_PLL2_FREQ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_PLL2_FREQ` writer"]
pub struct W(crate::W<PLL_PLL2_FREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_PLL2_FREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_PLL2_FREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_PLL2_FREQ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FBDIV_FRAC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PLL_PLL2_FREQ_SPEC, u8, u8, 8, O>;
...
pub type FRAC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PLL_PLL2_FREQ_SPEC, u32, u32, 24, O>;
impl R {
...
#[doc = "PLLx frac mode frequency adjust\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_pll2_freq](index.html) module"]
pub struct PLL_PLL2_FREQ_SPEC;
impl crate::RegisterSpec for PLL_PLL2_FREQ_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_pll2_freq::R](R) reader structure"]
impl crate::Readable for PLL_PLL2_FREQ_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_pll2_freq::W](W) writer structure"]
impl crate::Writable for PLL_PLL2_FREQ_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PLL_PLL2_FREQ to value 0"]
impl crate::Resettable for PLL_PLL2_FREQ_SPEC {
