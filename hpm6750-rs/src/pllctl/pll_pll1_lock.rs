#[doc = "Register `PLL_PLL1_LOCK` reader"]
pub struct R(crate::R<PLL_PLL1_LOCK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_PLL1_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_PLL1_LOCK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_PLL1_LOCK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PLL_PLL1_LOCK` writer"]
pub struct W(crate::W<PLL_PLL1_LOCK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PLL_PLL1_LOCK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PLL_PLL1_LOCK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PLL_PLL1_LOCK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOCK_SS_RSTPTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_LOCK_SPEC, bool, O>;
...
pub type LOCK_REFDIV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_LOCK_SPEC, bool, O>;
...
pub type LOCK_POSTDIV1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_LOCK_SPEC, bool, O>;
...
pub type LOCK_SS_SPEAD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_LOCK_SPEC, bool, O>;
...
pub type LOCK_SS_DIVVAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, PLL_PLL1_LOCK_SPEC, bool, O>;
impl R {
...
#[doc = "PLLx lock control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_pll1_lock](index.html) module"]
pub struct PLL_PLL1_LOCK_SPEC;
impl crate::RegisterSpec for PLL_PLL1_LOCK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_pll1_lock::R](R) reader structure"]
impl crate::Readable for PLL_PLL1_LOCK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pll_pll1_lock::W](W) writer structure"]
impl crate::Writable for PLL_PLL1_LOCK_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PLL_PLL1_LOCK to value 0"]
impl crate::Resettable for PLL_PLL1_LOCK_SPEC {
    #[inline(always)]
