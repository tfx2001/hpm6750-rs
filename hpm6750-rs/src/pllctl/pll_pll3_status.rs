#[doc = "Register `PLL_PLL3_STATUS` reader"]
pub struct R(crate::R<PLL_PLL3_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PLL_PLL3_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PLL_PLL3_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PLL_PLL3_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PLLx status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pll_pll3_status](index.html) module"]
pub struct PLL_PLL3_STATUS_SPEC;
impl crate::RegisterSpec for PLL_PLL3_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pll_pll3_status::R](R) reader structure"]
impl crate::Readable for PLL_PLL3_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PLL_PLL3_STATUS to value 0"]
impl crate::Resettable for PLL_PLL3_STATUS_SPEC {
    #[inline(always)]
