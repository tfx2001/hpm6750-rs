#[doc = "Register `CHCTRL_CH4_DSTADDR` reader"]
pub struct R(crate::R<CHCTRL_CH4_DSTADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHCTRL_CH4_DSTADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHCTRL_CH4_DSTADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHCTRL_CH4_DSTADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHCTRL_CH4_DSTADDR` writer"]
pub struct W(crate::W<CHCTRL_CH4_DSTADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHCTRL_CH4_DSTADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHCTRL_CH4_DSTADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHCTRL_CH4_DSTADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DSTADDRL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHCTRL_CH4_DSTADDR_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "Channel n Destination Address Low Part Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [chctrl_ch4_dstaddr](index.html) module"]
pub struct CHCTRL_CH4_DSTADDR_SPEC;
impl crate::RegisterSpec for CHCTRL_CH4_DSTADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [chctrl_ch4_dstaddr::R](R) reader structure"]
impl crate::Readable for CHCTRL_CH4_DSTADDR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chctrl_ch4_dstaddr::W](W) writer structure"]
impl crate::Writable for CHCTRL_CH4_DSTADDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CHCTRL_CH4_DSTADDR to value 0x01"]
impl crate::Resettable for CHCTRL_CH4_DSTADDR_SPEC {
    #[inline(always)]
