...
#[doc = "Status Register"]
pub mod stat;
#[doc = "WIDTH (rw) register accessor: an alias for `Reg<WIDTH_SPEC>`"]
pub type WIDTH = crate::Reg<width::WIDTH_SPEC>;
#[doc = "Image width register"]
pub mod width;
#[doc = "HEIGHT (rw) register accessor: an alias for `Reg<HEIGHT_SPEC>`"]
...
#[doc = "Buf Access Addr"]
pub mod bufaddr;
#[doc = "BUFDATA (rw) register accessor: an alias for `Reg<BUFDATA_SPEC>`"]
pub type BUFDATA = crate::Reg<bufdata::BUFDATA_SPEC>;
#[doc = "Buf Access Data"]
pub mod bufdata;
#[doc = "OUTDMACNT (r) register accessor: an alias for `Reg<OUTDMACNT_SPEC>`"]
