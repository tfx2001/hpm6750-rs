...
#[doc = "Field `C4` reader - Two's compliment Blue U/Cb multiplier coefficient. YUV=0x208 (2.032) YCbCr=0x204 (2.017)."]
pub type C4_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C4` writer - Two's compliment Blue U/Cb multiplier coefficient. YUV=0x208 (2.032) YCbCr=0x204 (2.017)."]
pub type C4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CSC_COEF1_SPEC, u16, u16, 11, O>;
#[doc = "Field `C1` reader - Two's compliment Red V/Cr multiplier coefficient. YUV=0x123 (1.140) YCbCr=0x198 (1.596)."]
pub type C1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `C1` writer - Two's compliment Red V/Cr multiplier coefficient. YUV=0x123 (1.140) YCbCr=0x198 (1.596)."]
