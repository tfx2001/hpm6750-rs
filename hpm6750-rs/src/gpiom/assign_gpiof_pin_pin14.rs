#[doc = "Register `ASSIGN_GPIOF_PIN_PIN14` reader"]
pub struct R(crate::R<ASSIGN_GPIOF_PIN_PIN14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASSIGN_GPIOF_PIN_PIN14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASSIGN_GPIOF_PIN_PIN14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASSIGN_GPIOF_PIN_PIN14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASSIGN_GPIOF_PIN_PIN14` writer"]
pub struct W(crate::W<ASSIGN_GPIOF_PIN_PIN14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASSIGN_GPIOF_PIN_PIN14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ASSIGN_GPIOF_PIN_PIN14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ASSIGN_GPIOF_PIN_PIN14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ASSIGN_GPIOF_PIN_PIN14_SPEC, bool, O>;
...
pub type HIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASSIGN_GPIOF_PIN_PIN14_SPEC, u8, u8, 4, O>;
...
pub type SELECT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASSIGN_GPIOF_PIN_PIN14_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "GPIO mananger\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [assign_gpiof_pin_pin14](index.html) module"]
pub struct ASSIGN_GPIOF_PIN_PIN14_SPEC;
impl crate::RegisterSpec for ASSIGN_GPIOF_PIN_PIN14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [assign_gpiof_pin_pin14::R](R) reader structure"]
impl crate::Readable for ASSIGN_GPIOF_PIN_PIN14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [assign_gpiof_pin_pin14::W](W) writer structure"]
impl crate::Writable for ASSIGN_GPIOF_PIN_PIN14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASSIGN_GPIOF_PIN_PIN14 to value 0"]
impl crate::Resettable for ASSIGN_GPIOF_PIN_PIN14_SPEC {
    #[inline(always)]
