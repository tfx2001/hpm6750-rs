#[doc = "Register `ASSIGN_GPIOX_PIN_PIN30` reader"]
pub struct R(crate::R<ASSIGN_GPIOX_PIN_PIN30_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASSIGN_GPIOX_PIN_PIN30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASSIGN_GPIOX_PIN_PIN30_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASSIGN_GPIOX_PIN_PIN30_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASSIGN_GPIOX_PIN_PIN30` writer"]
pub struct W(crate::W<ASSIGN_GPIOX_PIN_PIN30_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASSIGN_GPIOX_PIN_PIN30_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ASSIGN_GPIOX_PIN_PIN30_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ASSIGN_GPIOX_PIN_PIN30_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ASSIGN_GPIOX_PIN_PIN30_SPEC, bool, O>;
...
pub type HIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASSIGN_GPIOX_PIN_PIN30_SPEC, u8, u8, 4, O>;
...
pub type SELECT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ASSIGN_GPIOX_PIN_PIN30_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "GPIO mananger\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [assign_gpiox_pin_pin30](index.html) module"]
pub struct ASSIGN_GPIOX_PIN_PIN30_SPEC;
impl crate::RegisterSpec for ASSIGN_GPIOX_PIN_PIN30_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [assign_gpiox_pin_pin30::R](R) reader structure"]
impl crate::Readable for ASSIGN_GPIOX_PIN_PIN30_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [assign_gpiox_pin_pin30::W](W) writer structure"]
impl crate::Writable for ASSIGN_GPIOX_PIN_PIN30_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ASSIGN_GPIOX_PIN_PIN30 to value 0"]
impl crate::Resettable for ASSIGN_GPIOX_PIN_PIN30_SPEC {
    #[inline(always)]
