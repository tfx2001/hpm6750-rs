#[doc = "Register `ECC_KEY0` reader"]
pub struct R(crate::R<ECC_KEY0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ECC_KEY0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ECC_KEY0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ECC_KEY0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ECC_KEY0` writer"]
pub struct W(crate::W<ECC_KEY0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ECC_KEY0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ECC_KEY0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ECC_KEY0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ECC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ECC_KEY0_SPEC, u16, u16, 16, O>;
...
pub type RLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ECC_KEY0_SPEC, bool, O>;
...
pub type WLOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ECC_KEY0_SPEC, bool, O>;
impl R {
...
#[doc = "Key ECC and access control\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ecc_key0](index.html) module"]
pub struct ECC_KEY0_SPEC;
impl crate::RegisterSpec for ECC_KEY0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ecc_key0::R](R) reader structure"]
impl crate::Readable for ECC_KEY0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ecc_key0::W](W) writer structure"]
impl crate::Writable for ECC_KEY0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ECC_KEY0 to value 0"]
impl crate::Resettable for ECC_KEY0_SPEC {
