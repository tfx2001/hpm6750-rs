#[doc = "Register `CHANNEL_CHN1_CFG` reader"]
pub struct R(crate::R<CHANNEL_CHN1_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL_CHN1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL_CHN1_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL_CHN1_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL_CHN1_CFG` writer"]
pub struct W(crate::W<CHANNEL_CHN1_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL_CHN1_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL_CHN1_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL_CHN1_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HYST_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, u8, u8, 2, O>;
...
pub type DACEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type HPMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type CMPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type MINSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, u8, u8, 3, O>;
...
pub type CMPOEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type FLTBYPS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type WINEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type OPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type SYNCEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, bool, O>;
...
pub type FLTLEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CHANNEL_CHN1_CFG_SPEC, u16, u16, 12, O>;
impl R {
...
#[doc = "Configure Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [channel_chn1_cfg](index.html) module"]
pub struct CHANNEL_CHN1_CFG_SPEC;
impl crate::RegisterSpec for CHANNEL_CHN1_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [channel_chn1_cfg::R](R) reader structure"]
impl crate::Readable for CHANNEL_CHN1_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channel_chn1_cfg::W](W) writer structure"]
impl crate::Writable for CHANNEL_CHN1_CFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CHANNEL_CHN1_CFG to value 0"]
impl crate::Resettable for CHANNEL_CHN1_CFG_SPEC {
    #[inline(always)]
