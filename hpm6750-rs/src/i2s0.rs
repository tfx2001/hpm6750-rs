...
pub struct RegisterBlock {
    ...
    pub rfifo_fillings: crate::Reg<rfifo_fillings::RFIFO_FILLINGS_SPEC>,
    #[doc = "0x08 - Tx FIFO Filling Level"]
    pub tfifo_fillings: crate::Reg<tfifo_fillings::TFIFO_FILLINGS_SPEC>,
    #[doc = "0x0c - TX/RX FIFO Threshold setting."]
    pub fifo_thresh: crate::Reg<fifo_thresh::FIFO_THRESH_SPEC>,
    #[doc = "0x10 - Status Registers"]
    pub sta: crate::Reg<sta::STA_SPEC>,
    _reserved5: [u8; 0x0c],
    #[doc = "0x20 - Rx Data0"]
    pub rxd_data0: crate::Reg<rxd_data0::RXD_DATA0_SPEC>,
    #[doc = "0x24 - Rx Data1"]
    pub rxd_data1: crate::Reg<rxd_data1::RXD_DATA1_SPEC>,
    #[doc = "0x28 - Rx Data2"]
    pub rxd_data2: crate::Reg<rxd_data2::RXD_DATA2_SPEC>,
    #[doc = "0x2c - Rx Data3"]
    pub rxd_data3: crate::Reg<rxd_data3::RXD_DATA3_SPEC>,
    #[doc = "0x30 - Tx Data0"]
    pub txd_data0: crate::Reg<txd_data0::TXD_DATA0_SPEC>,
    #[doc = "0x34 - Tx Data1"]
    pub txd_data1: crate::Reg<txd_data1::TXD_DATA1_SPEC>,
    #[doc = "0x38 - Tx Data2"]
    pub txd_data2: crate::Reg<txd_data2::TXD_DATA2_SPEC>,
    #[doc = "0x3c - Tx Data3"]
    pub txd_data3: crate::Reg<txd_data3::TXD_DATA3_SPEC>,
    _reserved13: [u8; 0x10],
    #[doc = "0x50 - Configruation Regsiters"]
    pub cfgr: crate::Reg<cfgr::CFGR_SPEC>,
    _reserved14: [u8; 0x04],
    #[doc = "0x58 - Misc configuration Registers"]
    pub misc_cfgr: crate::Reg<misc_cfgr::MISC_CFGR_SPEC>,
    _reserved15: [u8; 0x04],
    #[doc = "0x60 - Rx Slots Enable for Rx Data0"]
    pub rxdslot_data0: crate::Reg<rxdslot_data0::RXDSLOT_DATA0_SPEC>,
    #[doc = "0x64 - Rx Slots Enable for Rx Data1"]
    pub rxdslot_data1: crate::Reg<rxdslot_data1::RXDSLOT_DATA1_SPEC>,
    #[doc = "0x68 - Rx Slots Enable for Rx Data2"]
    pub rxdslot_data2: crate::Reg<rxdslot_data2::RXDSLOT_DATA2_SPEC>,
    #[doc = "0x6c - Rx Slots Enable for Rx Data3"]
    pub rxdslot_data3: crate::Reg<rxdslot_data3::RXDSLOT_DATA3_SPEC>,
    #[doc = "0x70 - Tx Slots Enable for Tx Data0."]
    pub txdslot_data0: crate::Reg<txdslot_data0::TXDSLOT_DATA0_SPEC>,
    #[doc = "0x74 - Tx Slots Enable for Tx Data1."]
    pub txdslot_data1: crate::Reg<txdslot_data1::TXDSLOT_DATA1_SPEC>,
    #[doc = "0x78 - Tx Slots Enable for Tx Data2."]
    pub txdslot_data2: crate::Reg<txdslot_data2::TXDSLOT_DATA2_SPEC>,
    #[doc = "0x7c - Tx Slots Enable for Tx Data3."]
    pub txdslot_data3: crate::Reg<txdslot_data3::TXDSLOT_DATA3_SPEC>,
}
#[doc = "CTRL register accessor: an alias for `Reg<CTRL_SPEC>`"]
pub type CTRL = crate::Reg<ctrl::CTRL_SPEC>;
#[doc = "Control Register"]
pub mod ctrl;
#[doc = "RFIFO_FILLINGS register accessor: an alias for `Reg<RFIFO_FILLINGS_SPEC>`"]
pub type RFIFO_FILLINGS = crate::Reg<rfifo_fillings::RFIFO_FILLINGS_SPEC>;
#[doc = "Rx FIFO Filling Level"]
pub mod rfifo_fillings;
#[doc = "TFIFO_FILLINGS register accessor: an alias for `Reg<TFIFO_FILLINGS_SPEC>`"]
pub type TFIFO_FILLINGS = crate::Reg<tfifo_fillings::TFIFO_FILLINGS_SPEC>;
#[doc = "Tx FIFO Filling Level"]
pub mod tfifo_fillings;
#[doc = "FIFO_THRESH register accessor: an alias for `Reg<FIFO_THRESH_SPEC>`"]
...
pub mod sta;
#[doc = "RXD_DATA0 register accessor: an alias for `Reg<RXD_DATA0_SPEC>`"]
pub type RXD_DATA0 = crate::Reg<rxd_data0::RXD_DATA0_SPEC>;
#[doc = "Rx Data0"]
pub mod rxd_data0;
#[doc = "RXD_DATA1 register accessor: an alias for `Reg<RXD_DATA1_SPEC>`"]
pub type RXD_DATA1 = crate::Reg<rxd_data1::RXD_DATA1_SPEC>;
#[doc = "Rx Data1"]
pub mod rxd_data1;
#[doc = "RXD_DATA2 register accessor: an alias for `Reg<RXD_DATA2_SPEC>`"]
pub type RXD_DATA2 = crate::Reg<rxd_data2::RXD_DATA2_SPEC>;
#[doc = "Rx Data2"]
pub mod rxd_data2;
#[doc = "RXD_DATA3 register accessor: an alias for `Reg<RXD_DATA3_SPEC>`"]
pub type RXD_DATA3 = crate::Reg<rxd_data3::RXD_DATA3_SPEC>;
#[doc = "Rx Data3"]
pub mod rxd_data3;
#[doc = "TXD_DATA0 register accessor: an alias for `Reg<TXD_DATA0_SPEC>`"]
pub type TXD_DATA0 = crate::Reg<txd_data0::TXD_DATA0_SPEC>;
#[doc = "Tx Data0"]
pub mod txd_data0;
#[doc = "TXD_DATA1 register accessor: an alias for `Reg<TXD_DATA1_SPEC>`"]
pub type TXD_DATA1 = crate::Reg<txd_data1::TXD_DATA1_SPEC>;
#[doc = "Tx Data1"]
pub mod txd_data1;
#[doc = "TXD_DATA2 register accessor: an alias for `Reg<TXD_DATA2_SPEC>`"]
pub type TXD_DATA2 = crate::Reg<txd_data2::TXD_DATA2_SPEC>;
#[doc = "Tx Data2"]
pub mod txd_data2;
#[doc = "TXD_DATA3 register accessor: an alias for `Reg<TXD_DATA3_SPEC>`"]
