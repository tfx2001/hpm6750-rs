#[doc = "Register `PAD_PC26_PAD_CTL` reader"]
pub struct R(crate::R<PAD_PC26_PAD_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD_PC26_PAD_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD_PC26_PAD_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD_PC26_PAD_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD_PC26_PAD_CTL` writer"]
pub struct W(crate::W<PAD_PC26_PAD_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD_PC26_PAD_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD_PC26_PAD_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD_PC26_PAD_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, bool, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, bool, O>;
...
pub type SMT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, bool, O>;
...
pub type PS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, bool, O>;
...
pub type PE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, bool, O>;
...
pub type DS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PAD_PC26_PAD_CTL_SPEC, u8, u8, 3, O>;
impl R {
...
#[doc = "PAD SETTINGS\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pad_pc26_pad_ctl](index.html) module"]
pub struct PAD_PC26_PAD_CTL_SPEC;
impl crate::RegisterSpec for PAD_PC26_PAD_CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pad_pc26_pad_ctl::R](R) reader structure"]
impl crate::Readable for PAD_PC26_PAD_CTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pad_pc26_pad_ctl::W](W) writer structure"]
impl crate::Writable for PAD_PC26_PAD_CTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PAD_PC26_PAD_CTL to value 0x1010"]
impl crate::Resettable for PAD_PC26_PAD_CTL_SPEC {
    #[inline(always)]
